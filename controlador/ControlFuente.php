    ...
    class ControlFuente{
	   ...
	   var $objFuente;
        ...
        function validarIngreso(){
                $msg = "ok";
                $validar = false;
                $usu = $this->objFuente->getNomFuente(); 
                $con = $this->objFuente->getNombre();
                $comandoSql = "SELECT * FROM tblFuente WHERE nomFuente='$usu' AND Nombre='$con'";
        ...
        function consultarRolesPorFuente($nomUsu){
            $msg = "ok";
            $listadoRolesDelFuente = [];
            $comandoSQL = "SELECT fkIdRol FROM tblrol_Fuente WHERE fkNomFuente='$nomUsu'";
            $objControlConexion = new ControlConexion();
            $objControlConexion->abrirBd($GLOBALS['serv'], $GLOBALS['usua'], $GLOBALS['pass'], $GLOBALS['bdat'], $GLOBALS['port']);
            $recordSet = $objControlConexion->ejecutarSelect($comandoSQL);
            try
