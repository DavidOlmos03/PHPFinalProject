	...
	<div class="modal-dialog modal-login">
		<div class="modal-content">
			<div class="modal-header">
				<div class="avatar">
					<img src="vista/img/avatarLogin.png" alt="Avatar">
				</div>				
			...
			<div class="modal-body">
				<form action="login.php" method="post">
					<div class="form-group">
						<input type="text" class="form-control" name="txtEmail" placeholder="Username" required="required" value="<?php echo $ema ?>">		
					</div>
					<div class="form-group">
						<input type="password" class="form-control" name="txtContrasena" placeholder="Password" required="required" value="<?php echo $con ?>">	
					</div>        
					<div class="form-group">
						<button type="submit" name='bt' class="btn btn-primary btn-lg btn-block login-btn" value="Login">Login</button>
					</div>
				</form>
			</div>
