		...
		<div class="table-wrapper">
			<div class="table-title">
				<div class="row">
					...
					<div class="col-sm-6">
						<a href="#crudModal" class="btn btn-danger" data-toggle="modal"><i class="material-icons">&#xE84E;</i> <span>Gestión Fuentes</span></a>
			...
			<table class="table table-striped table-hover">
				...
				<tbody>
					<?php
					for($i = 0; $i < count($arregloFuentes); $i++){
					?>
						<tr>
							<td>
								<span class="custom-checkbox">
							...
							<td><?php echo $arregloFuentes[$i]->getId();?></td>
							<td><?php echo $arregloFuentes[$i]->getNombre();?></td>
							<td>
...
<div id="crudModal" class="modal fade">
	<div class="modal-dialog">
		<div class="modal-content">
			<form action="vistaFuente.php" method="post" id="Form">
