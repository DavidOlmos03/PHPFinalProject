<?php
	...
	//var_dump($arregloRepresenVisuals);
	...
	<div class="table-responsive">
		...
		<div class="table-wrapper">
			<div class="table-title">
				<div class="row">
					<div class="col-sm-6">
						<h2 class="miEstilo">Gestión <b>RepresenVisual</b></h2>
					</div>
					<div class="col-sm-6">
						<a href="#crudModal" class="btn btn-danger" data-toggle="modal"><i class="material-icons">&#xE84E;</i> <span>Gestión RepresenVisuals</span></a>
			...
			<table class="table table-striped table-hover">
				...
				<tbody>
					<?php
					for($i = 0; $i < count($arregloRepresenVisuals); $i++){
					?>
						<tr>
							<td>
								<span class="custom-checkbox">
							...
							<td><?php echo $arregloRepresenVisuals[$i]->getId();?></td>
							<td><?php echo $arregloRepresenVisuals[$i]->getNombre();?></td>
							<td>
...
<div id="crudModal" class="modal fade">
	<div class="modal-dialog">
		<div class="modal-content">
			<form action="vistaRepresenVisual.php" method="post" id="Form">
				<div class="modal-header">						
					<h4 class="modal-title">RepresenVisual</h4>
