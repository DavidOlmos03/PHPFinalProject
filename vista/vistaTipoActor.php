		...
		<div class="table-wrapper">
			<div class="table-title">
				<div class="row">
					...
					<div class="col-sm-6">
						<a href="#crudModal" class="btn btn-danger" data-toggle="modal"><i class="material-icons">&#xE84E;</i> <span>Gestión TipoActors</span></a>
			...
			<table class="table table-striped table-hover">
				...
				<tbody>
					<?php
					for($i = 0; $i < count($arregloTipoActors); $i++){
					?>
						<tr>
							<td>
								<span class="custom-checkbox">
							...
							<td><?php echo $arregloTipoActors[$i]->getId();?></td>
							<td><?php echo $arregloTipoActors[$i]->getNombre();?></td>
							<td>
...
<div id="crudModal" class="modal fade">
	<div class="modal-dialog">
		<div class="modal-content">
			<form action="vistaTipoActor.php" method="post" id="Form">
