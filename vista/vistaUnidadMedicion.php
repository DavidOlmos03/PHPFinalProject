<?php
	...
	if (isset($_POST['txtNombre'])) $des = $_POST['txtNombre'];
	switch ($boton) {
		case 'Guardar':
	...
	<div class="table-responsive">
		...
		<div class="table-wrapper">
			<div class="table-title">
				<div class="row">
					<div class="col-sm-6">
						<h2 class="miEstilo">Gestión <b>Unidad Mediccion</b></h2>
					</div>
					<div class="col-sm-6">
						<a href="#crudModal" class="btn btn-danger" data-toggle="modal"><i class="material-icons">&#xE84E;</i> <span>Unidad Mediccion</span></a>
				...
				<tbody>
					...
					?>
						<tr>
							<td>
								<span class="custom-checkbox">
									<input type="checkbox" id="checkbox1" des="options[]" value="1">
...
<div id="crudModal" class="modal fade">
	<div class="modal-dialog">
		<div class="modal-content">
			<form action="vistaUnidadMedicion.php" method="post" id="Form">
				...
				<div class="modal-body">
					...
					<div class="form-group">
						...
						<input type="text" id="txtNombre" name="txtNombre" class="form-control" value="<?php echo $des ?>">
					</div>
					<div class="form-group">
